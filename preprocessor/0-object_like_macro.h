/*
 *  To check if the macro was not previously defined 
 */
#ifndef _OBJECT_LIKE_MACRO_H_
/*
 * It is used to define it, so we avoid including it many times.
 * This way the content is processed only once.
 */
